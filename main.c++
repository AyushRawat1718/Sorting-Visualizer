...
void bubble_sort(vector<int> &arr, int size){
    ...
    for (int i = size-1; i>=0; i--){
        ...
        if (is_sorted) {
            ...
            cout<<"--------------------------------------------------"<<endl;
            cout<<"| No. of Swaps - "<<swap_counter<<" , "<<"No. of Comparisons - "<<comparison_counter<<"    |"<<endl;
            cout<<"--------------------------------------------------"<<endl;
            return ;
        }
    ...
    switch(first){
        ...
        case 'B': {
            ...
            if (second == 'C'){
                ...
                printVector(arr);
                cout<<endl<<endl;
                cout<<"Comparing Insertion Sort & Selection Sort on the above Array!!"<<endl<<endl;                
                pair<int, int> insertion_ans = insertion_sort_2(arr, size);
                pair<int, int> selection_ans = selection_sort_2(arr, size);
                cout<<"For Insertion Sort ->"<<endl;
                cout<<"--------------------------------------------------"<<endl;
                ...
                cout<<"--------------------------------------------------"<<endl;
                cout<<endl;
                if (((insertion_ans.first * 1.0) / (insertion_ans.second * 1.0)) < ((selection_ans.first * 1.0) / (selection_ans.second * 1.0 ))){
                    cout<<"-----------------------------------------------------------------------------------------"<<endl;
                    cout<<"| So According to Comparisons / Swaps Ratio - Insertion Sort is efficient for this array!!! |"<<endl;
                    cout<<"-----------------------------------------------------------------------------------------"<<endl;
                }
